            ...
            <ol class="questions">
                ...
                if ($result -> num_rows > 0){
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<button type='submit' name='editQuestion' value='$row[Question_ID]' class='edit-link'>Edit</button>";
                        //echo "<button type='submit' name='editQuestions' value='$examID'>Questions</button>";
                        echo '</form>';
                        //echo "<a href='add-question.php?qID={$row['Question_ID']}' class='edit-link'>Edit</a>";
                        echo "</li>";
                    }
                }
                else
                    echo "<p class='empty-exam'>No questions found</p>";
                ?>
            </ol>
            <a href="add-question.php" class="add-question-button">Add Question</a>
            </div>
